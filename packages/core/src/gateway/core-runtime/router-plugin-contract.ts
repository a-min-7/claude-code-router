...
export const ccrEmptyCompletionGuardResponseHookKey = "ccr-empty-completion-guard-response-hook";
export const ccrEmptyCompletionGuardStreamHookKey = "ccr-empty-completion-guard-stream-hook";
